...
export const SideBarFilter = () => {
    return (<>
        <div className="p-6 absolute left-0 border-r border-t rounded-xl h-full mt-8 w-fit border-black rounded-l-none">
            <div className="h-20 border-b border-black">
                <button className="btn btn-active btn-primary w-24 mr-4 rounded-full text-xs">Products</button>
                <button className="btn btn-outline btn-primary w-24 rounded-full text-xs">Farm</button>
            </div>
            <div>
